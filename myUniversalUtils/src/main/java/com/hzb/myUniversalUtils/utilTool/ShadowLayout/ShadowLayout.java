package com.hzb.myUniversalUtils.utilTool.ShadowLayout;

/**
 * FileName: ShadowLayout
 * Author: houzhengbang
 * Date: 2021/7/10 5:20 PM
 * Description:
 */
 ...
 * Created by leo
 * on 2019/7/9.
 * 阴影控件  来源  https://github.com/lihangleo2/ShadowLayout
 *
 *
 *
 *
...
public class ShadowLayout extends FrameLayout {
    ...
    private String default_shadow_color = "#2a000000";
    private String default_shadowback_color = "#fff";
    private String default_textColor = "#000";
    ...
    public void setShadowLimit(int mShadowLimit) {
        if (isShowShadow) {
            int dip5 = (int) getContext().getResources().getDimension(R.dimen.qb_px_5);
    ...
    private void initAttributes(AttributeSet attrs) {
        ...
        try {
            ...
            mCornerRadius = attr.getDimension(R.styleable.ShadowLayout_hl_cornerRadius, getResources().getDimension(R.dimen.qb_px_0));
...
//            mShadowColor = attr.getColor(R.styleable.ShadowLayout_hl_shadowColor, getResources().getColor(R.color.default_shadow_color));
            mShadowColor = attr.getColor(R.styleable.ShadowLayout_hl_shadowColor, Color.parseColor(default_shadow_color));
...
//            mBackGroundColor = getResources().getColor(R.color.default_shadowback_color);
            mBackGroundColor = Color.parseColor(default_shadowback_color);
